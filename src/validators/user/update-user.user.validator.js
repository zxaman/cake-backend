...
const updateUserValidator = () => {
  return [
    ...
    body("gender")
      ...
      .withMessage(
        `user role must be one of: ${Object.values(GenderEnum).join(", ")}`,
      ),
    body("address")
      .optional()
      .isString()
    ...
    body("userRole")
      ...
      .custom((value, { req }) => {
        ...
        if (userRole === UserRolesEnum.APPLICATION_ADMIN) {
          if (value === UserRolesEnum.APPLICATION_ADMIN) {
            throw new Error(`Application admin cannot update ${value} role`);
          }
        }
        return true;
      }),
